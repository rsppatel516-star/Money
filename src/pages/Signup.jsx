    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'var(--bg-color)', padding: '1rem' }}>
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '2rem' }}>
          <div style={{ backgroundColor: 'var(--success-light)', padding: '1rem', borderRadius: '50%', marginBottom: '1rem', color: 'var(--success)' }}>
            <Wallet size={40} />
          </div>
          <h1 style={{ fontSize: '1.75rem', fontWeight: 800, color: 'var(--text-main)', marginBottom: '0.25rem' }}>Create Account</h1>
          <p style={{ color: 'var(--text-muted)' }}>Start tracking your finances today</p>
        </div>
        ...
        <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          <div className="form-group" style={{ margin: 0 }}>
            ...
            <input required type="text" value={name} onChange={e => setName(e.target.value)} className="form-input" placeholder="Rudra Patel" />
          </div>
          <div className="form-group" style={{ margin: 0 }}>
          ...
          <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} type="submit" className="btn btn-primary" style={{ width: '100%', padding: '0.875rem', marginTop: '0.5rem', backgroundColor: 'var(--success)' }}>
            Create Account
          </motion.button>
        </form>
